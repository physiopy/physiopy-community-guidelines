...
project = "Physiopy Community Guidelines"
...
# documentation.
html_theme_options = {
    "light_logo": "logos/physiopy_logo_cut.png",
    "dark_logo": "logos/physiopy_logo_negative_cut.png",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": gh_url,
...
html_favicon = '_static/logos/favicon/onlyBrain.png'

# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "physiopy-community-guidelines"
